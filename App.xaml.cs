...
namespace NowReadable
{
    public partial class App : Application
    {
        ...
        /// </summary>
        /// <returns>The HomeViewModel object.</returns>
        ...
        {
            if (SettingsViewModel.AutoSync && MainViewModel.SyncCommand.CanExecute(null))
            {
                MainViewModel.SyncCommand.Execute(null);
            }
        }
        ...
        private void InitializePhoneApplication()
        {
            ...
            RootFrame.UriMapper = new ReadabilityApi.AssociationUriMapper();
